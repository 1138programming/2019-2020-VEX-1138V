...
AutonGroup1::AutonGroup1() {
  ...
  addSequentialCommand(new BaseLinearMovement(400, 280, 2, 0.005)); //drive forward to next cube, may not be necessary
  ...
  addSequentialCommand(new BaseLinearMovement(470, 420, 2, 0.003)); //may need to drive forward a little
  ...
  addSequentialCommand(new DriveForTime(KMaxMotorSpeed/3, -KMaxMotorSpeed/3, 1500)); //to turn 
  addSequentialCommand(new DriveForTime(KMaxMotorSpeed/2, KMaxMotorSpeed/2, 3000)); //drive forward into the zone
